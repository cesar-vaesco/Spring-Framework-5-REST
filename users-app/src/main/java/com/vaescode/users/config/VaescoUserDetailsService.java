...
import com.vaescode.users.repositories.UserInRoleRepository;
import com.vaescode.users.repositories.UserRepository;

@Service
public class VaescoUserDetailsService implements UserDetailsService {
	 ...
	 * Se inyecto el bean en lugar de volver a declarar la clase
	@Bean
	...
	public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
		...
		if (optional.isPresent()) {
			...
			List<UserInRole> userInRole = inRoleRepository.findByUser(user);
